		...
		-->
			...
			<div id="printableArea" style="font-family:'times new roman'">
				<table style"width:1200px; " border=" 0">
					...
					<tr>
						<td colspan="2"></td>
						<td align="center" style="border:1px solid black;"><b>&nbsp;<?php if (!empty($total[$times])) echo $total[$times] . '%'; ?></b></td>
				...
				<table style"width:1200px; " border=" 1">
					...
					<tr>
						...
						<td align="center"><?php echo $userGrades['per_participation'] / 2; ?>%</td>
						<td align="center"><?php echo $userGrades['per_participation']; ?>%</td>
						<td align="center"><?php echo $userGrades['sc_participation']; ?>%</td>
						<td align="center"><?php if ($userGrades['sc_participation'] < $userGrades['per_participation'] / 2) echo 'Fail';
					...
					<tr style="display:''" onclick="showHideThis(this,8);">
						...
						<td align="center"><?php echo $userGrades['per_exam'] / 2; ?>%</td>
						<td align="center"><?php echo $userGrades['per_exam']; ?>%</td>
						<td align="center"><?php echo $userGrades['sc_exam']; ?>%</td>
						<td align="center"><?php if ($userGrades['sc_exam'] < $userGrades['per_exam'] / 2) echo 'Fail';
											else if (!empty($userGrades['sc_exam'])) echo 'Pass'; ?></td>
						<td align="center" style="width:100px"><?php echo $userGrades['s2_exam']; ?></td>
						<td align="center"><?php if (!empty($userGrades['s3_exam'])) if ($userGrades['s2_exam'] < $userGrades['per_exam'] / 2) echo 'Fail';
											else if (!empty($userGrades['s2_exam'])) echo 'Pass'; ?></td>
						<td align="center"><?php echo $userGrades['s3_exam']; ?></td>
						<td align="center"><?php if (!empty($userGrades['s3_exam'])) if ($userGrades['s3_exam'] < $userGrades['per_exam'] / 2) echo 'Fail';
											else if (!empty($userGrades['s3_exam'])) echo 'Pass'; ?></td>
					</tr>
					<tr style="display:''" onclick="showHideThis(this,12);">
						<td colspan="4">&nbsp;Project</td>
						<td align="center"><?php echo $userGrades['per_project'] / 2; ?>%</td>
						<td align="center"><?php echo $userGrades['per_project']; ?>%</td>
						<td align="center"><?php echo $userGrades['sc_project']; ?>%</td>
						<td align="center"><?php if ($userGrades['sc_project'] < $userGrades['per_project'] / 2) echo 'Fail';
					...
					<tr bgcolor="#aaaaaa" style="height:40px">
						...
						<td colspan="2" align="center"><b><?php if ($times >= 0 && !empty($total[0])) echo $total[0] . '%<br>' . $grade[0]; ?></b></td>
						<td colspan="2" align="center"><b><?php if ($times >= 1 && !empty($total[1])) echo $total[1] . '%<br>' . $grade[1]; ?></b></td>
						<td colspan="2" align="center"><b><?php if ($times >= 2 && !empty($total[2])) echo $total[2] . '%<br>' . $grade[2]; ?></b></td>
					</tr>
				...
				<table style"width:1200px; " border=" 0">
					...
					<tr>
						<td>&nbsp;Prepared by</td>
						<td>:</td>
						<td colspan="6"><span id="spnPrepBy"><input id='txtPrepBy' type='text' value=''></span></td>
						<td colspan="4">Signed by</td>
					</tr>
					<tr>
						<td>&nbsp;Date</td>
						<td>:</td>
						<td><span id="spnPrepDate"><input id='txtPrepDate' type='text' value=''></span>
						<td colspan="6"></td>
					...
					<tr>
						<td colspan="8">&nbsp;</td>
						<td colspan="4"><b>Internal Assessor (内部审核员)</b></td>
					</tr>
					<tr>
						<td colspan="8">&nbsp;</td>
						<td>Name :</td>
						<td colspan="3"><span id="spnIntBy"><input id='txtIntBy' type='text' value=''></span></td>
					</tr>
					<tr>
						<td colspan="8">&nbsp;</td>
						<td>Date :</td>
						<td colspan="3"><span id="spnIntDate"><input id='txtIntDate' type='text' value=''></span></td>
					</tr>
				</table>
				<table style"width:1100px; " border=" 1">
					...
					<tr>
						<td style="text-align:center"><b>Grade</b>
						<td colspan="5" style="text-align:center"><b>Marks</b></td>
						<td colspan="5" style="text-align:center"><b>Evidence</b></td>
					</tr>
					<tr>
						<td style="text-align:center">A+
						<td colspan="5">&nbsp;90%-100%</td>
						<td colspan="5">&nbsp;Distinction</td>
					</tr>
					<tr>
						<td style="text-align:center">A
						<td colspan="5">&nbsp;85%-89%</td>
						<td rowspan="2" colspan="5">&nbsp;Very Good</td>
					</tr>
					<tr>
						<td style="text-align:center">A-
						<td colspan="5">&nbsp;80%-84%</td>
					</tr>
					<tr>
						<td style="text-align:center">B+
						<td colspan="5">&nbsp;75%-79%</td>
						<td rowspan="2" colspan="5">&nbsp;Good</td>
					</tr>
					<tr>
						<td style="text-align:center">B
						<td colspan="5">&nbsp;70%-74%</td>
					</tr>
					<tr>
						<td style="text-align:center">B-
						<td colspan="5">&nbsp;65%-69%</td>
						<td rowspan="2" colspan="5">&nbsp;Satisactory</td>
					</tr>
					<tr>
						<td style="text-align:center">C+
						<td colspan="5">&nbsp;60%-64%</td>
					</tr>
					<tr>
						<td style="text-align:center">C
						<td colspan="5">&nbsp;55%-59%</td>
						<td colspan="5">&nbsp;Weak</td>
					</tr>
					<tr>
						<td style="text-align:center">C-
						<td colspan="5">&nbsp;50%-54%</td>
						<td colspan="5">&nbsp;Pass</td>
					</tr>
					<tr>
						<td style="text-align:center">F
						<td colspan="5">&nbsp;0%-49%</td>
						<td colspan="5">&nbsp;Fail</td>
					</tr>
					<tr>
						<td style="text-align:center">P
						<td colspan="5">&nbsp;Pass after trying more than one attempt</td>
						<td colspan="5">&nbsp;Pass after trying more than one attempt</td>
					</tr>
					<tr>
